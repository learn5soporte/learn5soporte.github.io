...
+'.demo-prompt{font-family:"IBM Plex Mono",monospace;font-size:14px;color:var(--w);line-height:1.7;min-height:2.6em;margin-bottom:var(--s3)}'
...
+'.demo-resp em{font-style:normal;color:var(--teal-l);background:rgba(29,158,117,.12);border-radius:4px;padding:0 3px}'
