...
"Entrar a algo que no era para ti le cuesta tiempo a los dos. Mejor lo aclaramos ahora.":"Starting something that wasn't for you costs us both time. Better to sort it out now.",
...
"Haz primero el diagnóstico gratuito: son dos minutos y te dice si el programa encaja con lo que necesitas. Si ya dentro algo no cuadra, escríbeme y lo hablamos.":"Start with the free diagnostic: two minutes, and it tells you whether the programme fits what you need. If something doesn't add up once you're in, write to me and we'll talk.",
...
"Zelle a":"Zelle to",
 "Lanzamiento · primera cohorte":"Launch price · first cohort",
 "Desde la segunda cohorte":"From the second cohort on",
 "Pagar con tarjeta":"Pay by card",
 "Débito o crédito · pago seguro":"Debit or credit · secure checkout",
 "Pagar con PayPal":"Pay with PayPal",
 "Con tu cuenta, o con tarjeta como invitado":"With your account, or by card as a guest",
 "Pagar por Zelle":"Pay with Zelle",
 "Solo EE. UU. · sin comisión":"US only · no fees",
 "Datos para Zelle":"Zelle details",
 "En el concepto: tu nombre y":"In the memo: your name and",
 "Pagues como pagues, mándanos el comprobante por WhatsApp o por correo y te damos el acceso en menos de 24 horas. El cobro de PayPal aparece a nombre de Gelkin Pulido, fundador de Learn5.":"However you pay, send us the receipt on WhatsApp or by email and we give you access within 24 hours. The PayPal charge shows up under Gelkin Pulido, founder of Learn5.",
"— Bank of America, a nombre de Learn5 LLC.":"— Bank of America, under Learn5 LLC.",
"En el concepto: tu nombre y":"In the memo: your name and",
"Pago único. El cobro aparece a nombre de Gelkin Pulido, fundador de Learn5.":"One-time payment. The charge appears under Gelkin Pulido, founder of Learn5.",
"Inicio":"Home",
"Privacidad":"Privacy",
"Términos":"Terms",
